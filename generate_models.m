...
% enter a value of
% 0 for a small molecule ligand
% 1 for a 1-arm polymer bound ligand
...
% Initial and final concentrations rastered with pH
% General format is [ L1, L2, Ln, M1, M2, Mn, proton]

% THIS NEEDS TO CHANGE TO HML Style
% General format is [M1, M2, Mn, L1, L2, Ln]

% aka ligands, then metals, then proton.
% Leave proton as 0's. The pH range is handled seperately with pH range parameter
...
%initial_M_eqv =	[1,	5/3,		0/3,	0];
%final_M_eqv =	[1,	0/3,		5/3,	0];
% initial_M_eqv = [1, 0,	0];
% final_M_eqv =	[1, 5/3	0];
...
%species_input_model.beta_solids = 10.^model_solids_log_beta;
...
%species_input_model.polymer_ligand = polymer_ligand;
