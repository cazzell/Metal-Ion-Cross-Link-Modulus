...
for titration_number = 1:num_titrations
	...
	for ligand_number = 1:num_ligands+1
		...
		for metal_number = 1:num_metals+1
			...
			pA_numerator = nansum(ligand_stoich .* speciation.titration_number(titration_number).species(:,bound_indices),2);
			pB_numerator = nansum(metal_stoich .* speciation.titration_number(titration_number).species(:,bound_indices),2);
			
			mechanics.titration_number(titration_number).ligand(ligand_number).metal(metal_number).pA_numerator = pA_numerator;
			mechanics.titration_number(titration_number).ligand(ligand_number).metal(metal_number).pB_numerator = pB_numerator;
			mechanics.titration_number(titration_number).ligand(ligand_number).metal(metal_number).pA = pA_numerator ./ mechanics.titration_number(titration_number).total_ligand(ligand_number);
			mechanics.titration_number(titration_number).ligand(ligand_number).metal(metal_number).pB = pB_numerator ./ mechanics.titration_number(titration_number).total_metal(metal_number);
			...
			mechanics.titration_number(titration_number).ligand(ligand_number).metal(metal_number).pB_neglect_MOH = pB_numerator ./ (mechanics.titration_number(titration_number).total_metal(metal_number) - MOH_sum);
			
			% Calculate amount of free metal???
			
			%%
			% Calculate l_f_i and Calculate m_g_j
